  ...
  return (
    <section>
      <div className="container">
        <button
          onClick={() => setNav(!nav)}
          className="px-3 py-2 min-h-[30px]  max-w-[200px]     lg:hidden w-full my-[20px] flex items-center justify-center text-white text-xs leading-[12px] font-plus_jakarta font-medium bg-green rounded-[4px]"
        >
          Open Slidebaar
        </button>
              ...
              <div className="relative pl-[9px]">
                ...
                {activeDropdown === "location" && (
                  <ul className="absolute bg-white shadow-md py-2 z-10">
                    ...
                    <li className="block cursor-pointer px-4 py-1 text-sm font-plus_jakarta font-medium leading-[22px] text-darkgray"
          ...
          >
              ...
              <div className=" flex gap-[10px]">
                ...
                <div className="relative max-md:hidden">
                  ...
                  {activeDrop === "experience" && (
                    <ul className="absolute bg-white shadow-md py-2 z-10">
                      <li className="block px-4 py-1 cursor-pointer text-sm font-plus_jakarta font-medium leading-[22px] text-darkgray"
            ...
            >
              {cardsData.map((data, index) => (
                <div
                  key={index}
                  className="hover:bg-transparent bg-light-gray max-w-[987px] duration-300 ease-linear mt-[30px] max-lg:mt- border border-fade-blue hover:border-fade-blue2 rounded-[16px] pt-6 pb-[30px] ps-[25px] pe-5"
                >
            ...
            <div className=" flex gap-[9px] max-lg:justify-center items-center mt-[30px]">
